...
int main()
{
    ...
    wrongAnimal->makeSound();  // Wrong Animal Sound (because makeSound IS virtual in WrongAnimal)
    delete wrongAnimal;


    WrongCat badKitty;
    badKitty.makeSound();  // Moo? (Wrong sound, WrongCat's non-virtual method hides WrongAnimal's)
